...
function SendMail($name,$surname,$addressmail,$subject,$body){
	$mail = new PHPMailer();
	$mail->IsSMTP();
	$mail->CharSet = 'UTF-8';
	$mail->SMTPAuth = true;
	...
	$mail->Port = 25;
	$mail->Username = 'info@ezyunion.com';
	$mail->Password = 'ezyunion$ezyunion1234';
	
	$mail->FromName = '- EZYUnion -';
	$mail->From = $mail->Username;
	 
	$mail->AddAddress($addressmail, $name." ".$surname);
