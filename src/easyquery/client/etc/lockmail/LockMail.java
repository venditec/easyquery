...
package easyquery.client.etc.lockmail;

public class LockMail {
	
	private String MailDomain;
	
	public LockMail(){
		/*
		* This function, lock using of the app for a mail domain.
		* Only will be able to use this app the mail domain users.
		*/
		setMailDomain("@domain.com");
	}
