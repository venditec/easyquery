...
package easyquery.client.etc.security;
...
public class SecurityCode {
	...
	public SecurityCode(){
		...
		/*
		 * This is the security code to send a SRV_PHPScript request.
		 * Put the same security code of the PHP Scripts.
		 */
		setSecurityCode("12345");
	}
	...
	public String getSRVSecurityCode() {
		return SecurityCode;
	}
