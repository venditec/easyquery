...
/* Update of Paul Johnston implementation to using with Google Web Toolkit
 * Version 1.0 Copyright Ramon Segarra 2012.
...
public class SHA1 {
	...
	public static native String getSHA1(String s) /*-{
		//
		// A JavaScript implementation of the Secure Hash Algorithm, SHA-1, as defined
		// in FIPS 180-1
