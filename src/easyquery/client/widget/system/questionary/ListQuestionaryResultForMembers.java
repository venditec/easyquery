...
public class ListQuestionaryResultForMembers extends VerticalPanel {

	public ListQuestionaryResultForMembers(){
		setWidth("100%");
		...
		RequestBuilder REQ = new RequestBuilder(RequestBuilder.POST,URL.encode(GWT.getHostPageBaseURL() + "etc/lib/php/_private/SRV_GetQuestionariesMemberResult.php"));
				...
				public void onResponseReceived(Request request, Response response) {
					...
					if(response.getText().split("\\#")[0].equals("OK")){
						...
						for(int x=1;x<Rows.length;x++){
							...
							if(Lock.getValue().contains("1")) Edit.setVisible(false);
