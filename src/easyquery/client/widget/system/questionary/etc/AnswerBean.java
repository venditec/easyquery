...
import easyquery.client.widget.system.form.Check;

public class AnswerBean extends HorizontalPanel {

	public String AnswerID;
	public HTML CodeAnswer;
	public Check Check;
	
	public AnswerBean(String Id, String Answer){
		AnswerID = Id;
