...
package easyquery.client.widget.system.error;

import com.google.gwt.user.client.ui.HorizontalPanel;
import com.google.gwt.user.client.ui.Label;

public class Error extends HorizontalPanel {

	private Label Text;
	
	public Error(String ErrorText){
		setWidth("100%");
		setStyleName("ErrorPanel");
		Text = new Label(ErrorText);
		Text.setStyleName("ErrorText");
		add(Text);
		setCellHorizontalAlignment(Text, ALIGN_CENTER);
	}
