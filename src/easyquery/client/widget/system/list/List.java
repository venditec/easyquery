...
public class List extends VerticalPanel {

	public LinkedList<HorizontalPanel> ListHP;
	
	public List(){
		
		setWidth("100%");
		setStyleName("ListStyle");
		ListHP = new LinkedList<HorizontalPanel>();
	...
	public void ShowList(){
		for(int i=0;i<ListHP.size();i++){
			add(ListHP.get(i));
			setCellHorizontalAlignment(ListHP.get(i), ALIGN_CENTER);
		}
	}
}
